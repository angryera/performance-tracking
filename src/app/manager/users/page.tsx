...
export default function UsersPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div className={`${quicksand.variable} font-sans min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8`}>
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="flex justify-center">
            <Users className="w-12 h-12 text-white" />
          </div>
          <h2 className="mt-6 font-extrabold text-white text-3xl text-center">
            Redirecting...
          </h2>
  ...
  return (
    <div className={`${quicksand.variable}`}>
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="font-bold text-white text-2xl sm:text-3xl">User Management</h1>
          <p className="mt-1 text-white/80 text-sm sm:text-base">Manage and monitor all users in the system</p>
        </div>
      </div>
        ...
        <div className="flex sm:flex-row flex-col sm:justify-between sm:items-center space-y-3 sm:space-y-0">
          <div className="flex sm:flex-row flex-col sm:space-x-4 space-y-3 sm:space-y-0">
            ...
            <button
              ...
              className="bg-white hover:bg-gray-50 px-3 py-2 border border-gray-300 focus:border-indigo-500 rounded-md focus:ring-indigo-500 text-black sm:text-sm"
            >
              {sortOrder === 'asc' ? '↑' : '↓'}
            </button>
          </div>
      ...
      {/* Users Table */}
      <div className="bg-white shadow mb-8 sm:rounded-md overflow-hidden">
        {isLoadingUsers ? (
        ...
        {!isLoadingUsers && filteredAndSortedUsers.length === 0 && (
          <div className="py-12 text-center">
            <Users className="mx-auto w-12 h-12 text-white/60" />
            <h3 className="mt-2 font-medium text-white text-sm">No users found</h3>
